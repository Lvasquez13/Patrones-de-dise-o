...
public class Employee {
    ...
    public static class EmployeeBuilder implements IBuilder<Employee> {
        ...
        private final List<Contact> contac = new ArrayList<>();
        ...
        public EmployeeBuilder setContact(Contact contact) {
            this.contac.add(contact);
            return this;
        }

        public EmployeeBuilder setContact(String name, Phone phone, Address address) {
            this.contac.add(new Contact(name, phone, address));
            return this;
        }

        @Override
        public Employee build() {
            return new Employee(age, name, gender, address, phones, contac);
        }
    }
